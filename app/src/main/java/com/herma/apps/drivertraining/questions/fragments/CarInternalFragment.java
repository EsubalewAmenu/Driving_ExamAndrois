 ...
 */
public class CarInternalFragment extends Fragment
{
    ...
    {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.car_internal, container, false);
